...
Public Class farMain4
    ...
    Private Sub fARViewer_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Me.Viewer1.Toolbar.ToolStrip.Items.Item(23).Visible = False
            Me.Viewer1.Toolbar.ToolStrip.Items.Item(23).Enabled = False
            Me.Viewer1.Toolbar.ToolStrip.Items.Item(24).Visible = False   'Extra separator bar
    ...
    Private Sub farMain4_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Try
            If iCallingFS IsNot Nothing Then
    ...
    Private Sub farMain4_ResizeEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ResizeEnd
