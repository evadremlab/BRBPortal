...
Public Class fLoadFile
    ...
    ''' <summary>
    ''' fLoadFile is similar to fDirectory, in that is shows directories and files, but fLoadFile lets you specify a file to be
    ''' loaded.  If you choose a file, the file name is put in the FileName textbox.  When you press Import, the program 
    ''' returns the full path to the calling program.
    ''' 
    ''' The File list is filtered based on the extension and the letters you've alredy typed into the File Name textbox.
    '''</summary>

    Public Sub New(ByVal aDrive As String, ByVal aDocPath As String, ByVal aViewLocalNetwork As Boolean, Optional ByVal aExtension As String = "")
        Try
            InitializeComponent()
            iIsLoading = True
            iDrive = aDrive
    ...
    Private Sub flDirectory_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If iExtension.Length > 0 Then
                Me.Text = "Import " & iExtension.ToUpper & " File"
            End If
            FillDrives()
            FillDir()
            iIsLoading = False
    ...
    Private Sub btnImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImport.Click
        Try
            ...
            If FName.Length = 0 Then
                MsgBox("File Name is required", MsgBoxStyle.Exclamation, "Can't Import File")
                Return
            End If
            ...
            If Not File.Exists(iSavePath) Then
