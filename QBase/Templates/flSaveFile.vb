...
Public Class flSaveFile
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtFileName.Text.Length < 5 Then
            MsgBoxErr("File name must end in .XLS")
            Return
        End If

        If txtFileName.Text.IndexOf(".ext", txtFileName.Text.Length - 4) < 0 Then
            MsgBoxErr("File name must end in .XLS")
            Return
        End If

        iCallingDocPath.Text = iPath & "\" & txtFileName.Text
