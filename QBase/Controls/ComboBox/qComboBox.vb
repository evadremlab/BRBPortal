Namespace Windows.Forms
    ...
    Public Class qComboBox
        ...
        'BHS 8/17/10 Add _BrowseDD Boolean.  If True, and population is 0 on dropdown, give warning to user to
        '  choose from Browse first.
...
#Region " IsBrowseDD Property "

        Private IsBrowseDD As Boolean = False
        <System.ComponentModel.Category("Data"),
            System.ComponentModel.Description("True if this combobox is to the right of a browse button.  OnDropdown, if no population, tells user to use browse button first"),
            System.ComponentModel.DesignerSerializationVisibility(System.ComponentModel.DesignerSerializationVisibility.Visible),
            System.ComponentModel.DefaultValue("")>
        Public Overridable Property _IsBrowseDD() As Boolean
            Get
                Return IsBrowseDD
            End Get
            Set(ByVal value As Boolean)
...
#Region " Combobox Control Events "
        ...
        Private Sub qComboBox_DropDown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.DropDown
            ...
            If IsBrowseDD = True Then
                If Me.Items IsNot Nothing AndAlso Me.SelectedValue IsNot Nothing Then
                    If Me.Items.Count = 0 Or
              (Me.Items.Count = 1 And Me.SelectedIndex = 0 And Me.SelectedValue.ToString = "") Then
                        MsgBox("You must click the Browse button to the left and choose items before you can list them here.", , "Information")
                    End If
                Else
                    MsgBox("You must click the Browse button to the left and choose items before you can list them here.", , "Information")
                End If
