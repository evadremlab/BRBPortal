...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="cartForm">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <asp:Button runat="server" id="btnPayCart" OnClick="PayCart_Click" Text="Pay Now" CssClass="btn btn-primary" ToolTip="Pay for your cart balance." />
                ...
                <asp:Button runat="server" id="btnCancelCart" OnClick="CancelCart_Click" Text="Cancel" CssClass="btn btn-default" ToolTip="Cancel any changes to this cart." style="margin-left:1rem;" />
            </div>
        </div>
    </section>
</asp:Content>
